...
const UI_VERSION = 'dashboard-ui-r1-v2'
    ...
    <main className="app-shell">
      ...
      <section className="main-grid">
        <article className="panel twin-panel">
          ...
          <div className="twin-state-row">
            ...
            <div><span>Device attitude</span><strong>{pose ? `ESTIMATED · ${pose.yaw_reference.toUpperCase()}` : 'NO POSE TELEMETRY'}</strong></div>
          </div>
        </article>
      ...
      <section className="charts-grid">
        ...
        <article className="panel integrity-panel">
          ...
          <div className="integrity-grid"><div><span>Success rate</span><strong>{successRate.toFixed(1)}%</strong></div><div><span>Failover rate</span><strong>{failoverRate.toFixed(1)}%</strong></div><div><span>Events in window</span><strong>{summary?.window_event_count ?? 0}</strong></div><div><span>Decision rows</span><strong>{health?.event_count ?? '—'}</strong></div></div>
